...
type Verify2FAResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Verif         bool                   `protobuf:"varint,1,opt,name=verif,proto3" json:"verif,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Verify2FAResponse) GetVerif() bool {
	if x != nil {
		return x.Verif
	}
	return false
...
func (x *GetUserByTokenRequest) Reset() {
	*x = GetUserByTokenRequest{}
	mi := &file_sso_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserByTokenRequest) Descriptor() ([]byte, []int) {
	return file_sso_service_proto_rawDescGZIP(), []int{10}
}
...
func (x *GetUserByTokenResponse) Reset() {
	*x = GetUserByTokenResponse{}
	mi := &file_sso_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserByTokenResponse) Descriptor() ([]byte, []int) {
	return file_sso_service_proto_rawDescGZIP(), []int{11}
}
...
func (x *GetUserByTokenResponse) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
const file_sso_service_proto_rawDesc = "" +
	...
	"\x05verif\x18\x01 \x01(\bR\x05verif\"*\n" +
	"\x0fSetup2FARequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\")\n" +
	"\x10Setup2FAResponse\x12\x15\n" +
	"\x06qr_url\x18\x01 \x01(\tR\x05qrUrl\"s\n" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role2\xfd\x02\n" +
	"\n" +
	"SSOService\x127\n" +
	...
	"\bSetup2FA\x12\x14.sso.Setup2FARequest\x1a\x15.sso.Setup2FAResponse\x12:\n" +
	"\tVerify2FA\x12\x15.sso.Verify2FARequest\x1a\x16.sso.Verify2FAResponseB9Z7github.com/LavaJover/shvark-sso-service/proto/gen;ssopbb\x06proto3"
...
var file_sso_service_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_sso_service_proto_goTypes = []any{
	(*Verify2FARequest)(nil),       // 0: sso.Verify2FARequest
	(*Verify2FAResponse)(nil),      // 1: sso.Verify2FAResponse
	(*Setup2FARequest)(nil),        // 2: sso.Setup2FARequest
	(*Setup2FAResponse)(nil),       // 3: sso.Setup2FAResponse
